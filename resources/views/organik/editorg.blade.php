...
@section('subtitle', 'Edit Form Hak Akses')
 ...
 <section class="content">
    ...
    &nbsp;&nbsp;<input name="layanan" id="layanan" type="radio" class="vpn" value="vpn" onchange="cekLayanan($(this).val())" {{ $upd->tbl_layanan_ict->nama_layanan == 'VPN' ? 'checked' : '' }}>VPN
        ...
        <div class="form-group">
        <label class="radio-inline">
    &nbsp;&nbsp;<input name="layanan" id="layanan" type="radio" class="namafileshare" value="fileshare" onchange="cekLayanan($(this).val())" {{ $upd->tbl_layanan_ict->nama_layanan == 'Fileshare' ? 'checked' : '' }}>Fileshare
        </label>
    ...
    <br>
        ...
        <label>Keterangan, Keperluan atau Alasan <b style="color:red;">*</b></label>
            <textarea class="form-control" rows="3" maxlength="1000" name="alasan" id="alasan" required="required">{{$upd->alasan}}</textarea>
        </div>
        </div>
        </div>
