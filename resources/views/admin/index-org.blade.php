					...
					<tr>
						...
						<td style="text-align:center;">
							<div class="btn-group-justified">
									...
									&nbsp;
									<a href="/admin-org/approve/{{$hao->id_hak_akses}}"><button type= "button" class="btn btn-success"><i class="fa fa-check" width="23px;"></i></button></a>
									&nbsp;
									<a href="/admin-org/decline/{{$hao->id_hak_akses}}"><button type= "button" class="btn btn-danger"><i class="fa fa-times" width="23px;"></i></button></a>
							</div>
