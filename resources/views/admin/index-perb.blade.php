...
@section('title', 'Form Perubahan Admin')

@section('contentadm')
@section('subtitle', 'Report Perubahan Admin')
	...
	<div class="row">
		<div class="col-lg-12">
				<div class="form-group">
					<a href="/admin-perb"><button class="btn dark" style="width:100px"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Refresh</button></a>
