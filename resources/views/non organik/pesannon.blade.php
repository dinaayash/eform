...
@section('content') 
@section('subtitle', 'Informasi Non Organik File Baru')
...
<a href="{{ route('create-non-organik') }}" class="link"><button type="button" name="setuju2" class="btn btn-info btn-rounded" style="float:right; margin-top:80px; width:100px">Agree&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></button></a>
