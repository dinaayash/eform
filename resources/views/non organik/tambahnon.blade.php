...
@section('content')	
@section('subtitle', 'Form Hak Aksess Non File Baru')
...
<style>
 ...
 <section class="content">
	...
	<div class="box box-default bayangan">
    	...
    	<tr>
			<td width="100%">
 			<input name="nama_atasan" id="nama_atasan" value="" type="text" class="form-control">
        ...
        <div class="form-group">
        <label>Jabatan</label>
        	<input name="jabatan_a" id="jabatan_a" placeholder="Jabatan" value="" type="text" class="form-control">
    ...
    &nbsp;&nbsp;<input name="layanan" id="layanan" type="radio" class="vpn" value="vpn" onchange="cekLayanan($(this).val())">VPN
        ...
        <div class="form-group">
        <label class="radio-inline">
    &nbsp;&nbsp;<input name="layanan" id="layanan" type="radio" class="com2" value="com" onchange="cekLayanan($(this).val())">Communication
        </label>
        ...
        <div class="form-group">
        <label class="radio-inline">
    &nbsp;&nbsp;<input name="layanan" id="layanan" type="radio" class="fileshare2" value="fileshare" onchange="cekLayanan($(this).val())">Fileshare
        </label>
